...
import hasibImage from "../../assets/images/hasibul_hasan.jpg";
    ...
    <div className="p-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-14">
      <div className="text-center">
        <h1 className="text-4xl font-bold">
          About Shikkha<span className="text-primary">Nir</span>
        </h1>
      </div>
      ...
      <div className="flex flex-col-reverse lg:flex-row gap-5 py-20 justify-center items-center lg:items-stretch">
        <div className="lg:pr-20">
          <p className="text-justify">
            Hello Good People. I'm <strong>Hasibul Hasan</strong> from{" "}
            <strong>
              Shikkha<span className="text-primary">Nir</span>
            </strong>
            . ShikkhaNir is the largest eLearning platform for everyone who want
            to learn from online. These includes academics and also skill based
            learning Courses.
            <br />
            ShikkhaNir Dedicated to serve for the people who actually wanted to
            know more things. Keep supporting us.
            <br />
            Now, it's your turn to build your own skill and represent yourself
            to the whole world.
            <br />
            <br />
            <span className="text-info font-bold">Oh, Yeah! Who am I? </span>
            <br />
