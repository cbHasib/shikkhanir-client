    ...
    <div className=" bg-gray-200 dark:bg-gray-900 flex flex-wrap items-center justify-center">
      <div className="container max-w-lg bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out m-12">
        <div className="h-2/4 sm:h-64 overflow-hidden">
          <img
            className="w-full rounded-t object-cover sm:h-64"
            src="https://firebasestorage.googleapis.com/v0/b/pshrd-d7d9f.appspot.com/o/shikkhanirServerWeb%2FinstructorImage%2FbgInstructor.jpg?alt=media&token=883e2307-30ea-4fc1-a182-5414d4a5b7b5"
            alt="PhotoUrl"
          />
        </div>
        ...
        <div className="">
          <div className="px-7 mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8">
              ...
              <button className="text-green-900 hover:text-green-700 p-1 sm:p-2  inline-flex items-center dark:text-gray-400 dark:hover:text-gray-30 dark:hover:text-gray-300">
                <svg
                  className="w-7 h-7 fill-current"
                  role="img"
                  viewBox="0 0 24 24"
